        ...
        <div className="flex-1 flex justify-end items-center gap-3">
          ...
          {loading ? (
            ...
            <Link to="/account" className="px-4 py-2 bg-black dark:bg-white rounded-lg flex justify-start items-center gap-3">
              ...
              <img src={isDark ? "/icons/homepage_login_icon.svg" : "/icons/login_icon.svg"} alt="Account Icon" className="w-5 h-5" />
            </Link>
          ) : (
            <Link to="/login" className="px-4 py-2 bg-black dark:bg-white rounded-lg flex justify-start items-center gap-3">
              ...
              <img src={isDark ? "/icons/homepage_login_icon.svg" : "/icons/login_icon.svg"} alt="Login Icon" className="w-5 h-5" />
            </Link>
          )}
        </div>
      </div>
