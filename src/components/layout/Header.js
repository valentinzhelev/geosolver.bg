...
const Header = () => {
  ...
  return (
    <>
      {/* Desktop Header */}
      <div className="hidden md:inline-flex max-w-[1660px] w-full px-6 py-3 bg-white border-b border-gray-200 justify-between items-center mx-auto">
        ...
        <div className="flex justify-start items-center gap-2">
          <Link
            to="/"
            className={`px-3 py-1 rounded-lg flex justify-center items-center gap-2.5 ${location.pathname === '/' ? 'text-black' : 'text-neutral-400'} text-base font-medium font-['Manrope']`}
          >
            Начало
          </Link>
          <Link
            to="/tools"
            className={`px-3 py-1 rounded-lg flex justify-center items-center gap-2.5 ${location.pathname === '/tools' ? 'text-black' : 'text-neutral-400'} text-base font-medium font-['Manrope']`}
          >
            Инструменти
          </Link>
          <div data-property-1="Default" className="px-3 py-1 rounded-lg flex justify-center items-center gap-2.5">
        ...
        <div className="fixed inset-0 z-50 bg-black bg-opacity-40 flex justify-center items-start pt-16">
          <div className="w-96 px-4 pt-12 pb-6 bg-white border-b border-gray-200 inline-flex flex-col justify-start items-start gap-6 rounded-lg shadow-lg">
            <div className="self-stretch inline-flex justify-between items-start">
              <div className="flex justify-start items-center gap-2">
                <div className="w-9 h-9 relative bg-black rounded-lg overflow-hidden">
                  <div className="w-4 h-5 left-[10.68px] top-[9px] absolute bg-white" />
                </div>
            ...
            <div className="self-stretch flex flex-col justify-center items-start gap-2">
              <div className="self-stretch p-3 rounded-lg outline outline-1 outline-offset-[-1px] outline-gray-200 inline-flex justify-start items-center gap-3">
                ...
                <img src="/right_arrow_icon.svg" alt="Arrow" className="w-3 h-3" />
              </div>
              <div className="self-stretch p-3 rounded-lg outline outline-1 outline-offset-[-1px] outline-gray-200 inline-flex justify-start items-center gap-3">
