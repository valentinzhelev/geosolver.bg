...
const Account = () => {
  ...
  const plan = {
    name: t.professionalPlanMonthly,
    daysActive: 216,
    daysToNext: 4,
  };
  ...
  const usageHistory = [
    { tool: t.firstBasicTask, date: '18.04.2025 14:25' },
    { tool: t.secondBasicTask, date: '18.04.2025 13:42' },
    { tool: t.forwardIntersection, date: '18.04.2025 12:15' },
    { tool: t.resection, date: '18.04.2025 11:33' },
    { tool: t.polarIntersection, date: '18.04.2025 10:58' },
    { tool: t.coordinateTransformation, date: '18.04.2025 09:21' },
    { tool: t.hansenTask, date: '18.04.2025 08:47' },
    { tool: t.areaCalculation, date: '18.04.2025 08:12' },
    { tool: t.distanceBearing, date: '18.04.2025 07:35' },
    { tool: t.firstBasicTask, date: '17.04.2025 16:44' }
  ];
  const paymentHistory = [
    { method: '**** 6225', amount: '19.99лв', date: '18.04.2025 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.03.2025 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.02.2025 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.01.2025 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.12.2024 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.11.2024 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.10.2024 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.09.2024 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.08.2024 14:25' },
    { method: '**** 6225', amount: '19.99лв', date: '18.07.2024 14:25' }
  ];
            ...
            <div className="w-96 inline-flex flex-col justify-center items-center gap-5">
              ...
              <div className="self-stretch rounded-[20px] flex flex-col justify-center items-center gap-1 relative overflow-hidden">
                ...
                <div className="self-stretch p-4 bg-white rounded-tl rounded-tr rounded-bl-xl rounded-br-xl shadow-[0px_8px_24px_0px_rgba(0,0,0,0.04)] outline outline-1 outline-offset-[-0.50px] outline-gray-200 flex flex-col justify-start items-start gap-4 overflow-hidden z-10 relative">
                  <div className="justify-start"><span className="text-black text-base font-medium font-['Manrope']">{plan.daysActive} {t.daysFromStart}</span></div>
                  <div className="justify-start"><span className="text-black text-base font-medium font-['Manrope']">{plan.daysToNext} {t.daysToNext}</span></div>
