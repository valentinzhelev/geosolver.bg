        ...
        <div className="w-full min-h-screen bg-stone-50">
          <div className="w-full max-w-[1180px] mx-auto px-4 lg:px-6 pt-6 lg:pt-20 pb-6 lg:pb-20 flex flex-col gap-6 lg:gap-10">
            ...
            <div className="flex flex-col lg:flex-row justify-start items-start gap-2 lg:gap-5">
              <Link
                to="/tools"
                className="w-full lg:flex-1 p-4 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex justify-between items-center transition-all duration-200 hover:outline-[0.5px] hover:outline-gray-400 hover:shadow-md hover:bg-gray-25"
              >
                <div className="text-black text-sm lg:text-base font-semibold font-['Manrope']">
                  {language === 'bg' ? 'Разгледай инструментите' : 'Explore Tools'}
                </div>
                <img src="/icons/hero_buttons_arrow.svg" alt="Arrow" className="w-1.5 h-2.5 lg:w-2 lg:h-3 transition-transform duration-200 group-hover:translate-x-1" />
              </Link>
              <Link
                to="/prices"
                className="w-full lg:flex-1 p-4 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex justify-between items-center transition-all duration-200 hover:outline-[0.5px] hover:outline-gray-400 hover:shadow-md hover:bg-gray-25"
            ...
            <div className="flex flex-col justify-center items-start gap-3 lg:gap-4">
              <div className="text-black text-lg lg:text-2xl font-bold font-['Manrope']">
                {language === 'bg' ? 'История на GeoSolver' : 'GeoSolver History'}
              </div>
              <div className="w-full p-4 lg:p-10 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-col justify-start items-start gap-10">
                <div className="w-full flex flex-col justify-center items-center gap-2 lg:gap-3">
                  <div className="text-black text-lg lg:text-2xl font-semibold font-['Manrope']">2023</div>
                  <div className="text-center text-black text-sm lg:text-lg font-semibold font-['Manrope']">
                    {language === 'bg' 
                ...
                <div className="w-full flex flex-row justify-start items-center gap-3 overflow-x-auto lg:overflow-visible pb-2 lg:pb-0">
                  <div className="px-3 py-1 bg-black rounded-lg flex justify-center items-center gap-2.5 flex-shrink-0">
                    <div className="text-white text-base lg:text-lg font-semibold font-['Manrope']">2023</div>
                  </div>
                  <div className="flex-1 h-0 outline outline-1 outline-offset-[-0.50px] outline-gray-200" />
                  <div className="px-3 py-1 bg-gray-200 rounded-lg flex justify-center items-center gap-2.5 flex-shrink-0">
                    <div className="text-black text-base lg:text-lg font-semibold font-['Manrope']">2024</div>
                  </div>
                  <div className="flex-1 h-0 outline outline-1 outline-offset-[-0.50px] outline-gray-200" />
                  <div className="px-3 py-1 bg-gray-200 rounded-lg flex justify-center items-center gap-2.5 flex-shrink-0">
                    <div className="text-black text-base lg:text-lg font-semibold font-['Manrope']">2025</div>
                  </div>
                  <div className="flex-1 h-0 outline outline-1 outline-offset-[-0.50px] outline-gray-200" />
                  <div className="px-3 py-1 bg-gray-200 rounded-lg flex justify-center items-center gap-2.5 flex-shrink-0">
